...
from chatbot_backend.chat.services.conversation_orchestrator import get_prompt_for_stage, orchestrate_conversation
...
def chat_api(request):
    ...
    try:
        ...
        # 🔹 1. User message (for lead extraction)
        user_message = data if isinstance(data, str) else json.dumps(data)
        ...
        # 🔹 3. Lead extraction & qualification (THIS IS THE ANSWER)
